...
function Header() {
    ...
    <div className={header.header}>
      <div className="container">
        <div className={header.left}>
          <div className={header.img}><svg version="1.0" xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 330.000000 150.000000"
  preserveAspectRatio="xMidYMid meet">

  <g className={header.svg} transform="translate(0.000000,150.000000) scale(0.100000,-0.100000)"
  ...
  -327 -2z"/>
          ...
          <div className={header.map}><NavLink to='#' className={header.nav}>Карта</NavLink></div>
          <div className={header.travel_routes}><NavLink to='#' className={header.nav}>Маршруты</NavLink></div>
        </div>
        <div className={header.signin}><NavLink to='#' className={header.nav}><FaUserCircle /></NavLink></div>
      </div>
    </div>
  )
};
